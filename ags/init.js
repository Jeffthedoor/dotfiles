...
`,
    ...
    async function applyStyle() {
        ...
        Utils.exec(`sass -I "${GLib.get_user_state_dir()}/ags/scss" -I "${GLib.get_user_state_dir()}/ags/scss/fallback" "${App.configDir}/scss/main.scss" "${COMPILED_STYLE_DIR}/style.css"`);
        App.resetCss();
